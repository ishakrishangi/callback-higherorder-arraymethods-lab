...
const contains = (arr, aName, callback) => {
...
// CODE HERE 
const each = (arr, cb) => {
  arr.forEach((naMes, index) => {return cb(naMes, index)} )
}
...
// CODE HERE
each(names, itemIndex = (item,inDex) => {
...
const add747 = addingFactory(747)
console.log(add747(5))
console.log(add747(10))
